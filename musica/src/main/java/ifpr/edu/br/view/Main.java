...
public class Main {
            ...
            switch (opcao) {
                case 1:
                    ...
                    for (Musica musica : controllerMusica.listarMusicas()) {
                        ...
                        System.out.printf(
                                "ID: %d | Nome: %s | Duração: %s | Dificuldade: %.1f | Bandas: %s | Estilos: %s | Instrumentos: %s\n",
                                musica.getMusicaID(), musica.getNome(), musica.getDuracao(), musica.getDificuldade(),
                                bandas, estilos, instrumentos);
                    }
                    limparBuffer();
                    System.out.print("Pressione Enter para continuar...\n");
                    limparBuffer();
                ...
                case 2:
                    ...
                    for (Banda banda : controllerBanda.listarBandas()) {
                        ...
                        System.out.printf("ID: %d | Agencia: %d | Nome: %s | Cantores: %s\n", banda.getBandaID(),
                                banda.getAgenciaID(), banda.getNome(), cantores);
                    }
                    limparBuffer();
                ...
                case 3:
                    ...
                    System.out.printf(
                            "Duração: %s\nDificuldade: %.1f\nBandas: %s\nEstilos: %s\n Instrumentos: %s\n\n%s\n\n",
                            musicaSelecionada.getDuracao(), musicaSelecionada.getDificuldade(), bandas, estilos,
                            instrumentos, musicaSelecionada.getLetra());
    ...
    public static void menuCantor(Cantor c) {
        Musica m = new Musica();
        Banda b = new Banda();
        while (true) {
            limparTela();
            ...
            switch (opcao) {
                ...
                case 2:
                    ...
                    while (true) {
                        ...
                        estilos.add(e);
                        System.out.printf("Estilo adicionado: %s\n", e.getNome());
                    ...
                    while (true) {
                        ...
                        bandas.add(b);
                        System.out.printf("Banda adicionada: %s\n", b.getNome());
                    ...
                    while (true) {
                        ...
                        instrumentos.add(i);
                        System.out.printf("Instrumento adicionado: %s\n", i.getNome());
                ...
                case 3:
                    ...
                    while (true) {
                        limparTela();
                        System.out.printf(
                                "Oque deseja modificar na musica?\n1.Nome\n2.Dificuldade\n3.Duração\n4.Letra\n5.Bandas\n6.Estilos\n7.Instrumentos\n8.Voltar");
                        limparBuffer();
                        ...
                        switch (alternativa) {
                            ...
                            case 7:
                                ...
                                resposta = Integer.parseInt(tecladoScanner.nextLine());
                                idmusica = m.getMusicaID();
                                List<Instrumento> intrumentosPorMusica = controllerMusica
                                        .listarInstrumentosPorMusica(idMusica);
                                if (resposta == 1) {
                                    limparTela();
                                    for (Instrumento instrumento : controllerInstrumento.listaInstrumentos()) {
                                    ...
                                    for (Instrumento instrumento : intrumentosPorMusica) {
                                        System.out.printf("%d - %s", instrumento.getInstrumentoID(),
                                                instrumento.getNome());
                                    }
                ...
                case 4:
                    ...
                    while (true) {
                        ...
                        System.out.printf(
                                "Oque deseja alterar em sua banda?\n1.Alterar o nome\n2.Mudar de agencia\n3.Tirar membros\n4.Voltar\n");
                        limparBuffer();
                        int alternativa = Integer.parseInt(tecladoScanner.nextLine());
                        switch (alternativa) {
                            case 1:
